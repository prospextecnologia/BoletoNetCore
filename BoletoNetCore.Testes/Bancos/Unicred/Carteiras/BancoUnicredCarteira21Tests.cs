...
{
    [TestFixture]
    [Category("Sicredi Carteira 21")]
    public class BancoUnicredCarteira21Tests
    {
        readonly IBanco _banco;
        public BancoUnicredCarteira21Tests()
        {
            var contaBancaria = new ContaBancaria
            {
                ...
                VariacaoCarteiraPadrao = "49531",
                TipoFormaCadastramento = TipoFormaCadastramento.ComRegistro,
                TipoImpressaoBoleto = TipoImpressaoBoleto.Empresa,
                OperacaoConta = "05"

            };
            _banco = Banco.Instancia(Bancos.Unicred);
            _banco.Beneficiario = TestUtils.GerarBeneficiario("80078487", "", "", contaBancaria);
            _banco.FormataBeneficiario();
        }

        [Test]
        public void Unicred_21_REM400()
        {
            TestUtils.TestarHomologacao(_banco, TipoArquivo.CNAB400, nameof(BancoUnicredCarteira21Tests), 8, true, "N", 00001);
        }

        [Test]
        public void Unicred_21_REM240()
        {
            TestUtils.TestarHomologacao(_banco, TipoArquivo.CNAB240, nameof(BancoUnicredCarteira21Tests), 8, true, "N", 00001);
        }
        ...
        public void Deve_criar_boleto_Unicred_21_var_A_com_digito_verificador_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
        ...
        [TestCase(200, "19200007", "6-2/3", "8", "19/200007-2", "74898813900000200001119200007201560585305100", "74891.11927 00007.201569 05853.051000 8 81390000020000", 2020, 01, 19)]
        [TestCase(200, "19200008", "6-3/3", "4", "19/200008-0", "74894817000000200001119200008001560585305105", "74891.11927 00008.001562 05853.051059 4 81700000020000", 2020, 02, 19)]
        public void Deve_criar_boleto_Unicred_21_var_A_com_nosso_numero_formatado_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
        ...
        [TestCase(200, "19200007", "6-2/3", "8", "19/200007-2", "74898813900000200001119200007201560585305100", "74891.11927 00007.201569 05853.051000 8 81390000020000", 2020, 01, 19)]
        [TestCase(200, "19200008", "6-3/3", "4", "19/200008-0", "74894817000000200001119200008001560585305105", "74891.11927 00008.001562 05853.051059 4 81700000020000", 2020, 02, 19)]
        public void Deve_criar_boleto_Unicred_21_var_A_com_codigo_de_barras_valido(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            var boleto = new Boleto(_banco)
            {
                DataVencimento = new DateTime(anoMesDia[0], anoMesDia[1], anoMesDia[2]),
        ...
        [TestCase(200, "19200007", "6-2/3", "8", "19/200007-2", "74898813900000200001119200007201560585305100", "74891.11927 00007.201569 05853.051000 8 81390000020000", 2020, 01, 19)]
        [TestCase(200, "19200008", "6-3/3", "4", "19/200008-0", "74894817000000200001119200008001560585305105", "74891.11927 00008.001562 05853.051059 4 81700000020000", 2020, 02, 19)]
        public void Deve_criar_boleto_Unicred_21_var_A_com_linha_digitavel_valida(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            var boleto = new Boleto(_banco)
            {
                DataVencimento = new DateTime(anoMesDia[0], anoMesDia[1], anoMesDia[2]),
...
";
        ...
        [TestCase(200, "19200007", "6-2/3", "8", "19/200007-2", "74898813900000200001119200007201560585305100", "74891.11927 00007.201569 05853.051000 8 81390000020000", 2020, 01, 19)]
        [TestCase(200, "19200008", "6-3/3", "4", "19/200008-0", "74894817000000200001119200008001560585305105", "74891.11927 00008.001562 05853.051059 4 81700000020000", 2020, 02, 19)]
        public async Task Sicredi_Online_RegistroBoleto_NecessarioInformar_ChaveMaster_Unicred_Testar_Com_Dados_de_Producao(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            /*
